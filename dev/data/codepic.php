...
$image = imagecreatetruecolor(140, 80); //创建画布
...
for ($$i = 0; $i < 100; $i++) {
    ...
    imagesetpixel($image, rand(1, 139), rand(1, 69), $pointcolor);
}
//设置干扰线
for ($i = 0; $i < 5; $i++) {
    $linecolor = imagecolorallocate($image, rand(50, 200), rand(50, 200), rand(50, 200));
    imageline($image, rand(1, 139), rand(1, 69), rand(1, 139), rand(1, 69), $linecolor);
}
//向浏览器输出图片头信息
